...
//        var d1 = LocalDate.of(2022, Month.JANUARY, 32) // DateTimeException - should be 31
...
//        date = date.plusMinutes(1); // DOES NOT COMPILE
    ...
    public static void demoLocalDate1() {
    ...
    public static void demoDuration() {
        ...
        System.out.println(date1.plus(period)); // 2022–05–26
        System.out.println(date1.plus(days)); // Unsupported unit: Seconds
    }
